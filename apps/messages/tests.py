...
class MessageTestBase(APITestCase):
    ...
    def setUp(self):
        ...
        # Team — author and member are in it, outsider is not
        ...
        # Base message authored by self.author
...
class MessageListTests(MessageTestBase):
    ...
    def test_list_without_channel_filter(self):
    ...
    def test_list_outsider_sees_no_messages(self):
...
class MessageRetrieveTests(MessageTestBase):
    ...
    def test_retrieve_message_outsider_no_access(self):
