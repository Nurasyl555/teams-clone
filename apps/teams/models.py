...
class Team(Model):
    ...
    owner = ForeignKey(CustomUser, on_delete=CASCADE, related_name="owned_teams")
    members = ManyToManyField(
        CustomUser, through="TeamMembership", related_name="members"
    )
...
class TeamMembership(Model):
    ...
    id = AutoField(primary_key=True)
    team = ForeignKey(Team, on_delete=CASCADE, related_name="team_memberships")
    user = ForeignKey(CustomUser, on_delete=CASCADE, related_name="user_memberships")
